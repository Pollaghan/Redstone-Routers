...
class Blocks {
    object PingBlock {
        ...
        fun PlaceBlock(PlaceLocation: String, sendingPlayer: String) {
            ...
            var CurrentIndex = RedstoneRouters.index
            Functions.RunCommand("execute at $sendingPlayer run summon minecraft:shulker $PlaceLocation {Silent:1b,Invulnerable:1b,NoAI:1b,AttachFace:0b,Tags:[\"PingBlock$CurrentIndex\"],active_effects:[{id:\"minecraft:invisibility\",amplifier:255,duration:999999,show_particles:0b,show_icon:0b,ambient:1b}],Passengers:[{id:\"minecraft:item_display\",Tags:[\"PingBlock$CurrentIndex\"],transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,-0.5f,0f],scale:[1.0f,1.0f,1.0f]},item:{id:\"minecraft:iron_block\",components:{\"minecraft:item_name\":\"Ping Block\"}}}]}")
        }
    }
}